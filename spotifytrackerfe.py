...
if "spotify_token" not in st.session_state:
    ...
    if code:
        ...
        st.markdown(
            f'<div style="text-align:center"><a href="{auth_url}" target="_self" style="background:#1DB954;color:black;padding:12px 32px;border-radius:30px;font-weight:bold;text-decoration:none;font-size:1.1rem;">Login with Spotify</a></div>',
            unsafe_allow_html=True,
        )
        st.stop()
